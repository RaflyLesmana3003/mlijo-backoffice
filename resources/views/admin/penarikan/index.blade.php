        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h2 text-white d-inline-block mb-0">Permintaan penariakn</h6>
                    <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                        <ol class="breadcrumb ">
                            <li class="breadcrumb-item "><a href="#" class="text-success">Home</a></li>
                            <li class="breadcrumb-item"><a href="#" class="text-success">Withdrawals</a></li>
    ...
    <div class="row justify-content-center">
        <div class="card col-12">
            ...
            <div class="card-header">
                <!-- Title -->
                <h5 class="h3 mb-0">Permintaan</h5>
            </div>
            <!-- Card body -->
            <div class="card-body">
                    ...
                    <table class="table table-flush" id="datatable-basic">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($mlijo->status == "0")
                                    <a href="#" class="btn btn-sm btn-success text-white" onclick="aktif({{$mlijo->id_user}})">approve</a>
                                    <a href="#" class="btn btn-sm btn-danger text-white" onclick="aktif({{$mlijo->id_user}})">reject</a>
                                    @else
